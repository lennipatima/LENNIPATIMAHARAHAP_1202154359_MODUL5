package com.example.lennipatimaharahap.lennipatimaharahap_1202154359_modul5;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void hapusgeser(){
        ...
        ItemTouchHelper.SimpleCallback touchcalll = new ItemTouchHelper.SimpleCallback(0, ItemTouchHelper.RIGHT) {
        ...
        ItemTouchHelper touchhelpi = new ItemTouchHelper(touchcalll);
        touchhelpi.attachToRecyclerView(rcView);
